...
listView : Bool -> Set Repo.EntityId -> Repo Authentication -> Html (Msg Authentication)
listView isDev usedAuthIds authRepo =
    let
    ...
    in
        Html.div []
            [ hipchatAuthDict
                ...
                |> cardBlock
                    [ Html.img [ Attr.src (Assets.url isDev "img/hipchat_square_40.png"), class "align-bottom mx-1", Attr.alt "Hipchat" ] []
